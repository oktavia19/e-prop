 ...
 * co BAPPEDA Tuban
 */
include APPPATH . "/libraries/excel-reader/SpreadsheetReader.php";
         ...
         */
             ...
             */
                                                    ...
                                                    $data = array(
                                                        ...
                                                        'jenis_pengajuan' =>$request->post('jenis_pengajuan'),
                                                        ...
                                                        'tahun_terakhir_menerima' =>$row[6] ,
                                                        'tanggal_permohonan' =>$row[7] ,
                                                        'nomor_permohonan' =>$row[8] ,
                                                        'nomor_penerbitan_rekomendasi' =>$row[9] ,
                                                        'pejabat_penerbitan_rekomendasi' =>$row[10] ,
                                                        'tanggal_penerbitan_rekomendasi' =>$row[11] ,
                                                        'tanggal_disposisi_bupati' =>$row[12] ,
                                                        'tanggal_pertimbangan_ketua_tapd' =>$row[13] ,
                                                        'isi_disposisi_ketua_tapd' =>$row[14] ,
                                                        'isi_disposisi_ketua_tapd' =>$row[14],
                                                        'created_at' =>$time,
                                                    ...
                                                    // var_dump($data);
                                                     ...
                                                     $this->db->insert('hibah_2022',$data);
                                                }
                                            }
                                        }
